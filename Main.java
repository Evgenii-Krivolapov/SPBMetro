...
public class Main {
    ...
    private static  Marker search = MarkerManager.getMarker("SearchFile");
    private static  Marker exception = MarkerManager.getMarker("ExceptionsFile");
    private static  Marker input_errors = MarkerManager.getMarker("InputErrorsFile");
    ...
    public static void main(String[] args) {
        ...
        for (; ; ) {
            try {
                ...
                List<Station> exception = new ArrayList<>(); //Создаём List
                exception.add(null); //Помещаем туда null
                List<Station> route = calculator.getShortestRoute(from, to);
                System.out.println("Маршрут:");
                printRoute(exception);  //Наш новый List добавляем в метод printRoute, для получении ошибки
          //      printRoute(route);
                logger.info("Правильно введённые станции: " + route);
                System.out.println("Длительность: " +
                        RouteCalculator.calculateDuration(route) + " минут");
                logger.info(search,"Cтанции " + route);
            } catch (Exception ex){
